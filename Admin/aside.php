          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="qlynhanvien.php"><i class="fa fa-circle-o"></i> Quản lý Nhân viên</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="qlydanhgia.php"><i class="fa fa-circle-o"></i> Đánh giá của khách hàng</a></li>
              </ul>
            </li>
        </section>
        <!-- /.sidebar -->
